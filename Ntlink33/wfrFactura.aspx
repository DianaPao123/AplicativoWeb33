...
//    $(".btn").click(function () {
//        $("#myModal").modal({
//            backdrop: false, //  Equivalente a data-backdrop
//            keyboard: false, //  Equivalente a teclado de datos
//            show: true, //  Equivalente a mostrar datos
//            remote: "" //  Equivalente a una etiqueta como href del disparador
//        });
//    });
//});
     ...
     function ShowPopup() {
            $('#MainContent_btnShowRFC').modal('show');
            return false;
        }
        function HideModal() {
            var modalPopup = $find('mpe');
            modalPopup.hide();
            $('#MainContent_btnShowRFC').modal('hide');
            return false;
    }
  ...
  <div class="modal-dialog">
    ...
    <%-- ...........................******************....................................... --%>
               ...
               <!-- Modal buscar por rfc-->
<%-- <div id="ModalRFC" class="modal fade" role="dialog" runat="server" data-keyboard="false">
  <div class="modal-dialog">
    <!-- Modal content-->
    <div class="modal-content">
         ...
         <div class = "row"> 
            <div class="col-lg-1"></div>
                  <div class = "form-group col-lg-10">
                        <asp:Label ID="Label38" class="control-label" runat="server" Text="RFC"></asp:Label>
                    <asp:TextBox runat="server" ID="txtRfcOlvide" CssClass="form-control" />
                    <asp:Label ID="lblRFC" class="control-label" runat="server" ForeColor="Red" Visible="false" Text="*Campo Obligatorio"></asp:Label>
     
                         </div>
            <div class="col-lg-1"></div>
      </div>
                <asp:Label ID="labSalida" class="control-label" runat="server" Text=""></asp:Label>
      </div>
      <div class="modal-footer">
                   <asp:LinkButton ID="btnBuscarRFC" CssClass="btn btn-default" 
                                      Text="Concepto" runat="server" OnClick="btnBuscarRFC_Click" >
 ...
 <asp:Button ID="btnShowRFC" runat="server" Style="display:none"  Text="Show Modal Popup" />
  
    <asp:ModalPopupExtender ID="ModalPopupRFC" BehaviorID="mpe" runat="server"
        PopupControlID="pnlPopupRFC" TargetControlID="btnShowRFC" 
        BackgroundCssClass="modalBackground">
    </asp:ModalPopupExtender>
    <div class="overrideClass " >
          <div class="modal-dialog" role="document" runat="server" id="pnlPopupRFC" Style="display:none">
                <div class="modal-content">
                    <div class="modal-header d-block bg-light" id="titulo"  style="padding:10px 10px 0 10px; ">
                        <h4 class="d-inline-block ml-3" id="myModalLabel" >
                            Buscar por RFC</h4>
                               <button type="button" class="close  bottom-ri    ght mr-3 btn-lg" aria-label="Close" onclick="HideModal()" style="font-size: 40px;">
                            <span aria-hidden="true">&times;</span></button>
                ...
                <div class = "col-12"> 
                  <div class="table-responsive  border border-dark">
                     ...
                     <asp:GridView ID="gvCfdiRelacionado" class="table table-bordered table-hover table-striped grdViewTable" 
                         ...
                         OnRowCommand="gvCfdiRelacionado_RowCommand" Width="100%" RowStyle-Height="5"
                         OnRowDataBound="gvCfdiRelacionado_RowDataBound">
                         <RowStyle  Height="10" Font-Size="16px"  cssclass="RowStyle" />
                         <FooterStyle  Font-Bold="True"  />
                         <PagerStyle  Height="5"  />
                         <HeaderStyle BackColor="#898c91" Font-Bold="True" ForeColor="White" Height="30px" />
...
<ul class="list-group d-inline-block list-group-flush">
  <li class="list-group-item p-0"> <asp:Label ID="lblSubtotal" runat="server" Text="pruebas"/></li>
  <li class="list-group-item p-0"> <asp:Label ID="lblRetenciones" runat="server" Text="pruebasfffdfdfdfffff" /></li>
  <li class="list-group-item p-0"><asp:Label ID="lblTraslados" runat="server" Text="pruebasfffffff" /></li>
  <li class="list-group-item p-0"><asp:Label ID="lblDescuento" runat="server" Text="pruebas" /></li>
  <li class="list-group-item p-0"><asp:Label ID="lblTotal" runat="server" Text="pruebastttt" /></li>
</ul>
                  </div>
                                   </div>
                          </div>
                  ...
                  <div class="btn-toolbar pull-right">
                        ...
                        <asp:LinkButton ID="btnLimpiar" CssClass="btn btn-default" 
                         ...
                         <asp:LinkButton ID="BtnVistaPreviaP" CssClass="btn btn-default" OnClientClick="Progress();" 
